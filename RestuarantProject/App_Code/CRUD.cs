...
/// </summary>
/// 
namespace RestuarantProject.App_Code
{
   public class CRUD
    {
        ...
        public static string conStr = WebConfigurationManager.ConnectionStrings["Ali_1988Constr"].ConnectionString;
        // I create a con object once and then use it in methods
        public SqlConnection con = new SqlConnection(WebConfigurationManager.ConnectionStrings["Ali_1988Constr"].ConnectionString);
        public CRUD()
        {
            //
